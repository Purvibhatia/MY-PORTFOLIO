...
export default function About() {
  ...
  const roles = ["Data Analyst", "IT Professional", "Insights • Efficiency"];
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-10 items-start">
          ...
          <main className="md:col-span-7 space-y-4">
            ...
            <div className={`${card} p-5 sm:p-6`}>
              <HelloRotator name="Purvi Bhatia" />
            ...
            <div className={`${card} p-5 sm:p-6`}>
              <p className="text-[1.05rem] leading-relaxed">
                ...
                <strong className="font-extrabold">
                  Data Analyst and IT Professional
                </strong>{" "}
                with hands-on experience in
                <span className="font-semibold bg-yellow-200 px-1 ml-1">
                  telecom KPI performance tracking
                </span>
                ,
                <span className="font-semibold bg-yellow-200 px-1 ml-1">
                ...
                , data cleaning, dashboard creation, and trend analysis, I
                specialize in transforming complex datasets into actionable
                business insights. I value
