            ...
            <div className="md:col-span-1 space-y-4">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center gap-2">
                  <FiMail /> <span>purvisophia7@gmail.com</span>
                </div>
                <div className="flex items-center gap-2">
                  <FiMapPin /> <span>Meerut, India</span>
                </div>
              </div>
            ...
            <div className="md:col-span-2">
              ...
              >
                ...
                <input
                  type="hidden"
                  name="_subject"
                  value="New message from Purvi’s portfolio"
                />
                ...
                <div className="md:col-span-2 flex items-center justify-between">
                  ...
                  <a
                    href="mailto:purvisophia7@gmail.com?subject=Hello%20Purvi"
