          ...
          >
            ...
            <div className="relative overflow-y-auto px-3 py-3 space-y-2">
              ...
              {messages.map((m, i) => (
                ...
                >
                  <div
                    className={`inline-block max-w-[85%] px-3 py-2 rounded-2xl border-2 border-black ${m.role === "user"
              ...
              {thinking && (
                <div className="inline-block px-3 py-2 rounded-2xl border-2 border-black bg-[#f5f5f5] shadow-[4px_4px_0_#000]">
                  <p className="text-[13px] opacity-70">Purvi is thinking…</p>
                </div>
              )}
              <div ref={endRef} />
            </div>
