      ...
      {namePositions.map((pos) => (
        <div
          ...
          style={{
            ...
            top: `${pos.y}%`,
            opacity: pos.opacity,
            transform: `skew(${pos.glitchIntensity * 10 - 5}deg) scale(${0.8 + pos.glitchIntensity * 0.4
              })`,
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full h-full flex items-center justify-center p-8">
        <img
          src="/purvi-portrait-v2.png"
          alt="Purvi Bhatia - Data Analyst Professional Portrait"
          ...
          style={{
            ...
            transform: isGlitching
              ? `translateX(${Math.random() * 4 - 2}px) translateY(${Math.random() * 4 - 2
              }px)`
              : "none",
