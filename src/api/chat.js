      ...
      {open && (
        ...
        >
          <div className="flex items-center justify-between px-3 py-2 border-b-2 border-black">
            <div className="font-semibold">Chat with Purvi</div>
            <button
          ...
          <div className="flex-1 overflow-y-auto px-3 py-2 space-y-2">
            {messages.map((m, i) => (
              ...
              >
                <div
                  className={`inline-block max-w-[85%] px-3 py-2 rounded-2xl border-2 border-black ${m.role === "user" ? "bg-[#d1f7c4]" : "bg-[#f5f5f5]"
                    }`}
                >
            ...
            {thinking && (
              <div className="inline-block max-w-[85%] px-3 py-2 rounded-2xl border-2 border-black bg-[#f5f5f5]">
                <p className="text-sm opacity-70">Purvi is thinking…</p>
              </div>
            )}
            <div ref={endRef} />
          </div>
          ...
          >
            <input
              ...
              placeholder="Ask about Purvi, projects, or anything…"
